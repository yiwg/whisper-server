...
exports.login = function (req, res, next) {
  console.info("there is action:user.login......");
  ...
  stringUtils.writeObj(userInfo,"userInfo");
  //openid和sessionid暂时写死
  var openId='xxxxyyyy';
  var sessionId=uuid.v4();
  User.updateOrSave(userInfo.nickName, userInfo.gender, userInfo.language, userInfo.city,
      userInfo.province, userInfo.country,userInfo.avatarUrl,openId,sessionId,function (err) {
        if(err){
          console.log(err);
        }
